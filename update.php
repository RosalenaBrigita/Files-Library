    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="database">
                ...
                <h1><center>Update Data Buku</center></h1>
                ...
                <div class="database-data">
                    ...
                    <table id="db">
                        <tr>
                            ...
                            <td>:</td>
                            <td><input type="text" name="kode" readonly value="<?php echo $kode ?>"></td>
                        </tr>

                        <tr>
                            <td>Judul Buku</td>
                            <td>:</td>
                            <td><input type="text" name="judul" size="30" required value="<?php echo $judul ?>"></td>
                        </tr>
                        <tr>
                            <td>Pengarang</td>
                            <td>:</td>
                            <td><input type="text" name="pengarang" size="30" required value="<?php echo $pengarang ?>"></td>
                        </tr>
                        <tr>
                            <td>Tahun Terbit</td>
                            <td>:</td>
                            <td><input type="number" name="tt" size="30" required value="<?php echo $tt ?>"></td>
                        </tr>
                        <tr>
                            <td>Penerbit</td>
                            <td>:</td>
                            <td><input type="text" name="penerbit" size="30" required value="<?php echo $penerbit ?>"></td>
                        </tr>
                        <tr>
                            <td>Jumlah Halaman</td>
                            <td>:</td>
                            <td><input type="number" name="jh" size="30" value="<?php echo $jh ?>"></td>
                        </tr>
                        <tr>
                            <td>kategori</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            ?>
                            <td><input type="file" name="cover_img" size="30" required value="<?php echo $cover?>"></td>;
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
